  ...
  return (
    <section className='py-5'>
       ...
       <div className='bg-red-400 lg:w-[45%] relative '> 
          <div className='absolute -bottom-200 rounded-2xl translate-y-19 lg:-translate-x-30 -translate-x-30 h-[880px] '>
            
            <img src="./557a7ae67532f2fb7d050a7eb4fa92ae7c59c367.png"className=' rounded-xl w-[250px]  lg:w-[345px]'  alt="" />
          </div>
          <div className=' absolute top-8 right-60 overflow-hidden w-[250px]  md:w-[343px] md:translate-x-70 translate-x-45 rounded-2xl  translate-y-22'>
